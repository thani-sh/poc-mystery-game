# Base Character Portrait Instructions
...
- Consistent stylized design so that every portrait looks like it belongs to the same game
...
- Portrait is centered within the frame, with the character occupying most of the space
...
All portraits of the same character must share:
